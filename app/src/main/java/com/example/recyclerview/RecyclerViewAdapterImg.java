...
public class RecyclerViewAdapterImg extends RecyclerView.Adapter<RecyclerViewAdapterImg.ImgViewHolder> {
    private Context mContext;
    private List<ImageCard> mData;

    public RecyclerViewAdapterImg(Context mContext, List<ImageCard> mData) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterImg.ImgViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
